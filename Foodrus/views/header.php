            ...
            <!-- Contenido del segundo menú -->
                <ul class="navbar-nav me-2">
                    <li class="nav-item mi-carta">
                        <a href="<?= URL_BASE ?>?controller=producto&action=carta" class="nav-link text-white carta">Carta</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= URL_BASE ?>?controller=producto&action=reseñas" class="nav-link text-white reseñas">Reseñas</a>
                    </li>
                </ul>
        </div>
    </nav>
